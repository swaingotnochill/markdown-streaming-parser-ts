...
export class Parser {
  ...
  /**
   * Update the tokens to parse. This is more efficient than creating a new Parser instance.
   * @param tokens New tokens to parse
   */
  ...
  parse(tokens?: Token[]): ASTNode {
    // If tokens are provided, update them first
    if (tokens) {
